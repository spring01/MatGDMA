...
t21c_22c = 1/2 * (35*rax*raz*rbx^2 - 35*rax*raz*rby^2 + 10*rax*rbx*czx - 10*rax*rby*czy + 10*raz*rbx*cxx - 10*raz*rby*cxy + 2*cxx*czx - 2*cxy*czy);
...
t21s_22c = 1/2 * (35*ray*raz*rbx^2 - 35*ray*raz*rby^2 + 10*ray*rbx*czx - 10*ray*rby*czy + 10*raz*rbx*cyx - 10*raz*rby*cyy + 2*cyx*czx - 2*cyy*czy);
t21s_22s = (35*ray*raz*rbx*rby + 5*ray*rbx*czy + 5*ray*rby*czx + 5*raz*rbx*cyy + 5*raz*rby*cyx + cyx*czy + cyy*czx);
t22c_22c = 1/4 * (35*rax^2*rbx^2 - 35*rax^2*rby^2 - 35*ray^2*rbx^2 + 35*ray^2*rby^2 + 20*rax*rbx*cxx - 20*rax*rby*cxy - 20*ray*rbx*cyx + 20*ray*rby*cyy + 2*cxx^2 - 2*cxy^2 - 2*cyx^2 + 2*cyy^2);
t22c_22s = 1/2 * (35*rax^2*rbx*rby - 35*ray^2*rbx*rby + 10*rax*rbx*cxy + 10*rax*rby*cxx - 10*ray*rbx*cyy - 10*ray*rby*cyx + 2*cxx*cxy - 2*cyx*cyy);
